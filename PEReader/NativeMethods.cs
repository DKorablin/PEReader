...
namespace AlphaOmega.Debug
{
	...
	internal static class NativeMethods
	{
		...
		public enum LoadLibraryFlags : UInt32
		{
			...
			/// <summary>
			/// Similar to <see cref="LOAD_LIBRARY_AS_DATAFILE"/>, except that the DLL file is opened with exclusive write access for the calling process.
			...
			/// If forced integrity checking is desired for the loaded file then LOAD_LIBRARY_AS_IMAGE is recommended instead.
			/// Unless the application depends on the image layout, this value should be used with either <see cref="LOAD_LIBRARY_AS_DATAFILE_EXCLUSIVE"/> or <see cref="LOAD_LIBRARY_AS_DATAFILE"/>.
			/// </summary>
			...
			/// To search for Lib2.dll in C:\Dir1 and all of the directories in the DLL search path, combine this value with <see cref="LOAD_LIBRARY_SEARCH_DEFAULT_DIRS"/>
			/// </summary>
			/// <remarks>This value cannot be combined with <see cref="LOAD_WITH_ALTERED_SEARCH_PATH"/>.</remarks>
			...
			/// </summary>
			/// <remarks>This value cannot be combined with any LOAD_LIBRARY_SEARCH_* flag</remarks>
