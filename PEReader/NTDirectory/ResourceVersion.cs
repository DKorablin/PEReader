	...
	public class ResourceVersion : ResourceBase
	{
		...
		public struct Translation
		{
			...
			public override String ToString()
			{
				...
				String charset = Encoding.GetEncoding(charsetID).EncodingName;
				switch(this.langID)
				{
				...
				default:
					lang = CultureInfo.GetCultureInfo(this.langID).DisplayName;
					break;
				}
		...
		public WinNT.Resource.VS_FIXEDFILEINFO? FileInfo
		{
			get
			{
