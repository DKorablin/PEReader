...
namespace AlphaOmega.Debug.NTDirectory
{
	...
	public class NTDirectoryBase : IDirectory, ISectionData
	{
		private readonly WinNT.IMAGE_DIRECTORY_ENTRY _directory;
		private readonly PEDirectory _parent;
		/// <summary>Директория PE файла</summary>
		internal PEDirectory Parent { get { return this._parent; } }
		...
		public NTDirectoryBase(PEDirectory parent, WinNT.IMAGE_DIRECTORY_ENTRY directory)
		{
			if(parent == null)
