...
namespace AlphaOmega.Debug.CorDirectory.Meta.Tables
{
	...
	public class ImplMapRow : BaseMetaRow
	{
		...
		public CorPinvokeMap MappingFlags => (CorPinvokeMap)base.GetValue<UInt16>(0);
		...
		public MetaCellCodedToken MemberForwarded => base.GetValue<MetaCellCodedToken>(1);

		/// <summary>Unmanaged method name</summary>
		public String ImportName => base.GetValue<String>(2);

		/// <summary>an index into the ModuleRef table</summary>
		internal MetaCellPointer ImportScopeI => base.GetValue<MetaCellPointer>(3);
